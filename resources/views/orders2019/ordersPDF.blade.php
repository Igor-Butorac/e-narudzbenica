...
$orders = DB::connection('mysql2')->table('orders')->where('orders.id','=', $url)->get();

$items = DB::connection('mysql2')
->table('items')
->where('order_id','=', $url)->get();
...
@foreach($orders as $order)
    ...
    <div class="divTable" style="">
        <div class="divTableBody">
            ...
            <?php           $kolicina_sum = DB::connection('mysql2')
            ->table('items')
        ...
        <?php $nacin_plac = DB::connection('mysql2')->table('orders') 
