...
<h1 style="text-align: center"> Prikaz narudžbenica za 2019. godinu </h1><br><br>
        <form action="{{ url('search')}}" method="POST" role="search" name="q"  class="form-inline my-2 my-lg-0" style="margin: 0 auto;padding: 0px;">          
...
@if(count($orders) > 0)
    ...
    <h3><a href="{{('orders2019')}}/{{$order->id}}">{{$order->id}}/19</a></h3>
